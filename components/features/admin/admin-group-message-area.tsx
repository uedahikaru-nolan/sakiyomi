...
import { getGroupChatDetails, deleteGroupMessage, updateGroupMessage } from '@/lib/actions/group-chat'
import Image from 'next/image'
import { generateGroupAIReply } from '@/lib/actions/ai-reply'
...
export function AdminGroupMessageArea({ groupId }: AdminGroupMessageAreaProps) {
  ...
  const handleGenerateAIReply = async () => {
    ...
    try {
      const result = await generateGroupAIReply(messages, currentUserId)
  ...
  const handleSubmitEdit = async () => {
    ...
    const result = await updateGroupMessage(editingMessageId, trimmed)
